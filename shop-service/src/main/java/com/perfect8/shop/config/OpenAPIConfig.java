...
/**
 * OpenAPI Configuration for Shop Service
 * 
 * Provides Swagger UI documentation at:
 * - Local: http://localhost:8085/swagger-ui.html
 * - Via Gateway: http://localhost:8080/shop/swagger-ui.html
 * 
...
public class OpenAPIConfig {
    ...
    public OpenAPI shopServiceOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Perfect8 Shop Service API")
                        .description("Product catalog, cart, orders, customers, and payment management for Perfect8 e-commerce")
                        .version("1.0.0")
                        .contact(new Contact()
                                .name("Perfect8 Team")
