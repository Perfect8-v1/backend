...
-- CATEGORIES
-- ============================================================================
INSERT INTO categories (category_id, name, slug, description, parent_id, is_active, created_date, updated_date) VALUES
...
-- PRODUCTS
-- ============================================================================
INSERT INTO products (product_id, name, slug, description, sku, price, discount_price, stock_quantity, weight, dimensions, category_id, is_active, is_featured, created_date, updated_date) VALUES
...
-- ORDER ITEMS
-- ============================================================================
INSERT INTO order_items (order_item_id, order_id, product_id, product_name, product_sku, quantity, unit_price, discount_amount, subtotal, item_status, created_date, updated_date) VALUES
...
-- PAYMENTS
-- ============================================================================
INSERT INTO payments (payment_id, order_id, payment_method, payment_status, amount, currency, transaction_id, gateway_payment_id, payment_date, created_date, updated_date) VALUES
...
-- CARTS
-- ============================================================================
INSERT INTO carts (cart_id, customer_id, item_count, total_amount, discount_amount, is_saved, created_date, updated_date) VALUES
(1, 3, 3, 3597.00, 0.00, false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- ============================================================================
-- CART ITEMS
-- ============================================================================
INSERT INTO cart_items (cart_item_id, cart_id, product_id, product_name, product_sku, quantity, unit_price, subtotal, added_date, updated_date) VALUES
